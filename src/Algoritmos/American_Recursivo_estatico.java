...
public class American_Recursivo_estatico {
    ...
    public static long[] americanaRecursivoEstatico(long[] arreglo1, long[] arreglo2) {
    ...
    private static void multiplicacionAmericanaRecursiva(long[] arreglo1, long[] arreglo2, long[] resultado, int i, int j) {
